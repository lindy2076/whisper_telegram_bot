class Response(str):
    ...
    UNKNOWN_FORMAT = "I can't convert this message type. It is not a voice message, video or video note."
    ...
    HELP = "Type /model to select (and download) Whisper model.\n\n" + \
        ...
        "Forward any voice or video note message here. Then wait and select text formatting.\n" + \
        "Github: github.com/lindy2076/whisper\_telegram\_bot"
    ...
    @classmethod
    def stt_response(cls, result, lang = None, mdl = None) -> str:
